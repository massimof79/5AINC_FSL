    ...
    if ($username === '' || $password === '') {
        ...
        try {
            ...
            if ($user && verifyUserPassword($password, (string) $user['password'])) {
                loginUser($user);
                $redirect = isset($_GET['next']) ? urldecode($_GET['next']) : 'index.php';
...
<head>
  ...
  <style>
    ...
    .btn-login { width:100%; justify-content:center; padding:0.65rem 1rem; font-size:var(--fs-base); margin-top:0.5rem; }
